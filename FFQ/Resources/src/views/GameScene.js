var GameLayer = cc.Layer.extend({
    ...
    init:function () {
        ...
        var hScrollLayer = cc.LayerColor.create(cc.c4b(128,128,128, 220));
        hScrollLayer.setTag(122);

        var hScrollView = game.ScrollView.create(cc.size(640, 960), hScrollLayer);
        hScrollView.setDirection(cc.SCROLLVIEW_DIRECTION_HORIZONTAL);
        hScrollView.setDelegate(this);
        this.addChild(hScrollView);
        ...
        hScrollLayer.addChild(scrollView);
        ...
        scrollView.setDelegate(hScrollView);
